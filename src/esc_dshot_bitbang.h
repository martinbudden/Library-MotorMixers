...
public:
    ...
    static uint32_t samples_to_gcr21(const uint32_t* samples, uint32_t motor_mask);
    static void gcr21_to_samples(uint32_t* samples, uint32_t motor_mask, uint32_t gcr21); // for test code
public:
