...
public:
    explicit MotorMixerWingBase(uint8_t output_to_motors_denominator) : 
        MotorMixerBase(FLYING_WING_SINGLE_PROPELLER, output_to_motors_denominator, MOTOR_COUNT, SERVO_COUNT) {}
public:
