...
float mix_quad_x(std::array<float, 4>& motor_outputs, const motor_mixer_commands_t& commands, motor_mixer_parameters_t& params) // NOLINT(readability-function-cognitive-complexity)
{
    ...
    for (auto& motor_output : motor_outputs) {
        motor_output = clamp(motor_output, params.motor_output_min, params.motor_output_max); // cppcheck-suppress useStlAlgorithm
    }
...
float mix_hex_x(std::array<float, 6>& motor_outputs, const motor_mixer_commands_t& commands, motor_mixer_parameters_t& params) // NOLINT(readability-function-cognitive-complexity)
{
    ...
    motor_outputs[0] = clamp(motor_outputs[0], params.motor_output_min, params.motor_output_max);
    motor_outputs[1] = clamp(motor_outputs[1], params.motor_output_min, params.motor_output_max);
    motor_outputs[2] = clamp(motor_outputs[2], params.motor_output_min, params.motor_output_max);
    motor_outputs[3] = clamp(motor_outputs[3], params.motor_output_min, params.motor_output_max);
#endif // LIBRARY_MOTOR_MIXERS_USE_NO_OVERFLOW_CHECKING_ROLL_PITCH
