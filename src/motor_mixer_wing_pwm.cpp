...
void MotorMixerWingPwm::write_motor(uint8_t motor_index, float motor_output) // NOLINT(readability-make-member-function-const_
{
...
*/
void MotorMixerWingPwm::output_to_motors(const motor_commands_t& motor_commands, RpmFilters* rpm_filters, float delta_t, uint32_t tick_count, Debug& debug)
{
    (void)rpm_filters;
    (void)delta_t;
    (void)tick_count;
